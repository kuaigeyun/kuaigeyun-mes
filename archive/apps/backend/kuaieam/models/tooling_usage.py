...
class ToolingUsage(BaseModel):
    """
    工装夹具使用记录模型
    
    用于管理工装夹具使用记录，支持多组织隔离。
    ...
    Attributes:
        ...
        tooling_id: 工装夹具ID（关联master-data）
        tooling_name: 工装夹具名称
        tooling_code: 工装夹具编码
    ...
    tooling_id = fields.IntField(description="工装夹具ID")
    tooling_name = fields.CharField(max_length=200, description="工装夹具名称")
    tooling_code = fields.CharField(max_length=100, null=True, description="工装夹具编码")
