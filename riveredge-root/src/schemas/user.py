...
class UserBase(BaseModel):
    ...
    is_platform_admin: bool = Field(default=False, description="是否为平台管理员（系统级超级管理员，需 tenant_id=None）")
...
class UserCreate(UserBase):
    ...
    Attributes:
        ...
        is_platform_admin: 是否为平台管理员（默认 False）
...
class UserUpdate(BaseModel):
    ...
    is_platform_admin: Optional[bool] = Field(None, description="是否为平台管理员（系统级超级管理员，需 tenant_id=None）")
