    ...
    >
      <Space wrap>
        ...
        {brief.document_type === 'performance_skill' ? (
          <Button type="primary" onClick={() => go(ROUTES.PERF_SKILLS)}>
        ...
        {brief.document_type === 'performance_holiday' ? (
          <Button type="primary" onClick={() => go(ROUTES.PERF_HOLIDAYS)}>
        ...
        {brief.document_type === 'performance_summary' ? (
          <Button type="primary" onClick={() => go(ROUTES.PERF_SUMMARIES)}>
        ...
        {brief.document_type === 'reporting_record' ? (
          <Button type="primary" onClick={() => go(ROUTES.REPORTING)}>
        ...
        brief.document_type === 'production_return' ? (
          <Button type="primary" onClick={() => go(ROUTES.WM_INBOUND)}>
