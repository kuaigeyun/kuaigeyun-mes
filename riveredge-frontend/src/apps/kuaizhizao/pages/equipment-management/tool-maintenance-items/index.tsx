...
import { maintenanceItemsApi } from '../../../services/toolOps';
...
const P = 'app.kuaizhizao.toolOps.maintenanceItem';

const RESOURCE = 'kuaizhizao:tool-maintenance-item';
...
const ToolMaintenanceItemsPage: React.FC = () => {
    ...
    <>
      ...
      <ListPageTemplate>
        ...
        viewTypes={['table', 'help']}
          helpViewConfig={buildDocumentListHelpViewConfig(DOCUMENT_LIST_HELP_KEYS.toolMaintenanceItems)}

          headerTitle={t(`${P}.title`)}

          columnPersistenceId="apps.kuaizhizao.pages.equipment-management.tool-maintenance-items-equip-rank-v1"
...
export default ToolMaintenanceItemsPage;
