    ...
    >
      <SchemaFormRenderer
        ...
        dropdownEnhanceMap={{
          ...
          customerLevelCode: { quickCreate: { label: '数据字典管理', onClick: () => navigate('/system/data-dictionaries') } },
          leadSourceCode: { quickCreate: { label: '数据字典管理', onClick: () => navigate('/system/data-dictionaries') } },
        }}
      />
    </FormModalTemplate>
  );
