  ...
  return (
    ...
    <KuaioaCrudListPage
      ...
      fields={[
        ...
        { name: 'scope_type', labelKey: 'app.kuaioa.announcement.scope', width: 100, type: 'select', options: SCOPE_OPTIONS },

        { name: 'effective_at', labelKey: 'app.kuaioa.announcement.effectiveAt', width: 160, type: 'datetime', hideInTable: true },

        { name: 'expires_at', labelKey: 'app.kuaioa.announcement.expiresAt', width: 160, type: 'datetime', hideInTable: true },

        { name: 'publisher_name', labelKey: 'app.kuaioa.announcement.publisher', width: 100 },

        { name: 'published_at', labelKey: 'app.kuaioa.announcement.publishedAt', width: 160, type: 'datetime' },

        { name: 'content', labelKey: 'app.kuaioa.announcement.content', hideInTable: true, required: true, type: 'textarea' },

        { name: 'scope_department', labelKey: 'app.kuaioa.announcement.scopeDepartment', hideInTable: true },
