...
const FALLBACK: Record<string, string> = {
  'payable.pull_from_purchase_order.not_allowed': '当前状态的采购订单不可上拉应付单',
  'payable.pull_from_purchase_order.no_lines': '采购订单无可应付金额',
  'payable.pull_from_purchase_order.already_pulled': '采购订单可应付金额已全部占用，删除未审核应付单后可再次上拉',
  'payable.pull_from_purchase_receipt.not_allowed': '当前状态的采购入库单不可上拉应付单',
  'payable.pull_from_purchase_receipt.no_lines': '采购入库单无可应付金额',
  'payable.pull_from_purchase_receipt.already_pulled': '采购入库单可应付金额已全部占用，删除未审核应付单后可再次上拉',
