...
const FALLBACK: Record<string, string> = {
  'receivable.pull_from_sales_order.not_allowed': '当前状态的销售订单不可上拉应收单',
  'receivable.pull_from_sales_order.no_lines': '销售订单无可应收金额',
  'receivable.pull_from_sales_order.already_pulled': '销售订单可应收金额已全部占用，删除未审核应收单后可再次上拉',
  'receivable.pull_from_sales_delivery.not_allowed': '当前状态的销售出库单不可上拉应收单',
  'receivable.pull_from_sales_delivery.no_lines': '销售出库单无可应收金额',
  'receivable.pull_from_sales_delivery.already_pulled': '销售出库单可应收金额已全部占用，删除未审核应收单后可再次上拉',
