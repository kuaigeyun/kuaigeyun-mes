...
import { Button, message, Space, Statistic, Row, Col, Divider, Timeline } from 'antd';
import { useParams, useNavigate } from 'react-router-dom';
import { receivableService } from '../../../services/finance/receivable';
import { Receivable } from '../../../types/finance/receivable';
import { ModalForm, ProFormMoney, ProFormDatePicker, ProFormTextArea, ProFormSelect } from '@ant-design/pro-components';
                ...
                <Col span={8}>
                    <ProCard title="财务状态" bordered headerBordered loading={loading}>
                        <Space direction="vertical" style={{ width: '100%' }} size="large">
                            ...
                            <div>审核: <span style={{ color: (data.review_status === '已审核' || data.review_status === '通过') ? 'green' : 'orange' }}>{data.review_status}</span></div>
                        </Space>
                    </ProCard>
