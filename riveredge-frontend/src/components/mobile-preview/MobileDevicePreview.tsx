...
export const MobileDevicePreview: React.FC<MobileDevicePreviewProps> = ({ open, onClose, url }) => {
    ...
    return (
        <Modal
            ...
            bodyStyle={{ height: Math.min(displayHeight * currentScale + 120, windowSize.height - 100), overflow: 'hidden', background: '#f0f2f5', display: 'flex', flexDirection: 'column', transition: 'height 0.3s ease', position: 'relative' }}
            footer={null}
            title={
