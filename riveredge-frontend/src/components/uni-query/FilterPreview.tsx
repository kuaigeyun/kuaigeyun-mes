  ...
  const advancedFilterTags = useMemo(() => {
    ...
    const processGroup = (group: FilterGroup, groupIndex: number) => {
      group.conditions.forEach((condition, conditionIndex) => {
        ...
        const operatorLabel = OPERATOR_I18N_KEY_MAP[condition.operator] ? t(OPERATOR_I18N_KEY_MAP[condition.operator]) : condition.operator;
    ...
    return tags;
  }, [filterGroups, filterableColumns, token, t]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{
          ...
          {t('components.uniQuery.currentFilterConditions')}
        </span>
        <Button
          type="text"
          size="small"
        ...
        >
          {t('components.uniQuery.clearAll')}
        </Button>
      </div>
