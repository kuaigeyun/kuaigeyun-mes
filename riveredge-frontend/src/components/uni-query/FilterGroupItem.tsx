      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span style={{ color: token.colorTextSecondary, fontSize: token.fontSizeSM }}>
            {level === 0 ? t('components.uniQuery.conditionGroup', { index: groupIndex + 1 }) : t('components.uniQuery.nestedGroup', { index: groupIndex + 1 })}
          </span>
          <Select
            value={group.logic}
            onChange={handleLogicChange}
            options={[
              { label: t('components.uniQuery.operatorAnd'), value: 'AND' },
              { label: t('components.uniQuery.operatorOr'), value: 'OR' },
            ]}
            size="small"
            style={{ width: 180 }}
          />
        ...
        <Button
          ...
          size="small"
        >
          {t('components.uniQuery.deleteGroup')}
        </Button>
      </div>
      ...
      <Space direction="vertical" size={4} style={{ width: '100%' }}>
        ...
        <Space size={8} style={{ width: '100%' }}>
          <Button
            ...
            size="small"
          >
            {t('components.uniQuery.addCondition')}
          </Button>
          {level < MAX_LEVEL && (
            <Button
              type="dashed"
              ...
              size="small"
            >
              {t('components.uniQuery.addNestedGroup')}
            </Button>
          )}
        </Space>
      </Space>
