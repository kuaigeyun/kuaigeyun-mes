...
import { OPERATOR_I18N_KEY_MAP } from './types';
...
export const FilterConditionItem: React.FC<FilterConditionProps> = ({
      ...
      case 'text':
        return (
          <Input
            ...
            placeholder={t('components.uniQuery.filterValuePlaceholder')}
            style={{ width: 200 }}
          />
        );
      ...
      case 'number':
          ...
          return (
            <Input.Group compact>
              <InputNumber
                ...
                placeholder={t('components.uniQuery.minValue')}
                style={{ width: '50%' }}
              />
              <InputNumber
        ...
        return (
          <InputNumber
            ...
            placeholder={t('components.uniQuery.numberPlaceholder')}
            style={{ width: 200 }}
          />
        );
        ...
        if (condition.operator === 'in' || condition.operator === 'not_in') {
          return (
            <Select
              ...
              onChange={handleValueChange}
              options={options}
              placeholder={t('components.uniQuery.selectOptionPlaceholder')}
              style={{ width: 200 }}
            />
          );
        }
  ...
  const operatorOptions = allowedOperators.map(op => ({
    label: t(OPERATOR_I18N_KEY_MAP[op]),
    value: op,
  }));
  ...
  return (
    <div style={{
      ...
      <Select
        ...
        placeholder={t('components.uniQuery.selectFieldPlaceholder')}
        style={{ width: 150 }}
      />
      <Select
        ...
        placeholder={t('components.uniQuery.selectOperatorPlaceholder')}
        style={{ width: 80 }}
      />
