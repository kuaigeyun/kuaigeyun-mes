...
const LEGACY_ENGLISH_HEADERS: Record<string, string[]> = {
  ...
  plantCode: ['plantCode', '*plantCode', '厂区编号', '厂区编码'],
  workshopCode: ['workshopCode', '*workshopCode', 'workshop_code', '车间编号', '车间编码'],
  productionLineCode: ['productionLineCode', '*productionLineCode', '产线编号', '产线编码'],
  warehouseType: ['warehouseType'],
  workCenterCode: ['workCenterCode'],
  storageAreaCode: ['storageAreaCode', '*storageAreaCode', '库区编号', '库区编码'],
  warehouseCode: ['warehouseCode', '*warehouseCode', '仓库编号', '仓库编码'],
  category: ['category'],
  version: ['version'],
  ...
  material: ['material', 'material_code', 'materialCode', '物料编号', '物料编码', '物料代码'],
