...
export default {
  ...
  'app.kuaizhizao.menu.cost-management.cost-comparison': 'Cost Comparison',
  ...
  'app.kuaizhizao.menu.warehouse-management.customer-material-registration': 'Customer Material',
