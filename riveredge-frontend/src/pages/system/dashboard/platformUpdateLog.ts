 ...
 * 平台更新日志（工作台版本卡展示）
 *
 * 通用条目写入 `PLATFORM_UPDATE_LOG_GENERAL` 头部；定制应用专属写入
 * `platformUpdateLogDedicated.ts` 的 `PLATFORM_UPDATE_LOG_DEDICATED` 头部。
 * 均须同步 zh-CN `pages.dashboard.updateLog.entries.{id}.*`（见 i18n-zh-cn-only）。
 *
...
import { PLATFORM_UPDATE_LOG_DEDICATED } from './platformUpdateLogDedicated';

export type PlatformUpdateType = 'major' | 'feature' | 'improvement' | 'fix' | 'security';

export type PlatformUpdateScope = 'general' | 'dedicated';
...
export interface PlatformUpdateLogEntry {
  ...
  /** 默认 general */
  scope?: PlatformUpdateScope;
  /** scope=dedicated 时必填；manifest 应用 code，不对用户展示 */
...
export const PLATFORM_UPDATE_LOG_GENERAL: PlatformUpdateLogEntry[] = [
  ...
  },
  {
    ...
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-governance-p2-r01.title',
    descriptionKey: 'pages.dashboard.updateLog.entries.permission-governance-p2-r01.description',
  },
  {
  ...
  },
  {
    ...
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r06.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r06.description',
  },
  {
    id: 'permission-require-codes-migrate-r05',
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r05.title',
    descriptionKey:
  ...
  },
  {
    ...
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r03.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r03.description',
  },
  {
    id: 'permission-require-codes-migrate-r02',
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r02.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r02.description',
  },
  {
    id: 'permission-require-codes-migrate-r01',
    date: '2026-09-24',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.permission-require-codes-migrate-r01.title',
    descriptionKey:
  ...
  },
  {
    ...
    date: '2026-09-24',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.drawing-vault-folder-inline-actions-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.drawing-vault-folder-inline-actions-r01.description',
  },
  {
    id: 'drawing-vault-tree-expand-r01',
    date: '2026-09-24',
    type: 'fix',
    titleKey: 'pages.dashboard.updateLog.entries.drawing-vault-tree-expand-r01.title',
    descriptionKey: 'pages.dashboard.updateLog.entries.drawing-vault-tree-expand-r01.description',
  },
  {
    id: 'update-log-dedicated-tab-r01',
    date: '2026-09-24',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.update-log-dedicated-tab-r01.title',
    descriptionKey: 'pages.dashboard.updateLog.entries.update-log-dedicated-tab-r01.description',
  },
  {
    id: 'update-log-dedicated-badge-visible-r01',
    date: '2026-09-24',
    type: 'fix',
    titleKey: 'pages.dashboard.updateLog.entries.update-log-dedicated-badge-visible-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.update-log-dedicated-badge-visible-r01.description',
  },
  {
    id: 'update-log-remove-haolisales-legacy-r01',
    date: '2026-09-24',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.update-log-remove-haolisales-legacy-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.update-log-remove-haolisales-legacy-r01.description',
  },
  {
    id: 'update-log-dedicated-scope-filter-r01',
    date: '2026-09-24',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.update-log-dedicated-scope-filter-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.update-log-dedicated-scope-filter-r01.description',
  },
  {
    id: 'app-menu-sync-client-channel-r01',
    date: '2026-09-24',
    type: 'fix',
    titleKey: 'pages.dashboard.updateLog.entries.app-menu-sync-client-channel-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.app-menu-sync-client-channel-r01.description',
  },
{
    id: 'dictionary-select-pending-i18n-label-r01',
    date: '2026-09-23',
    type: 'fix',
    titleKey: 'pages.dashboard.updateLog.entries.dictionary-select-pending-i18n-label-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.dictionary-select-pending-i18n-label-r01.description',
  },
{
    id: 'unitable-sparse-scroll-flash-r01',
    date: '2026-09-23',
    type: 'fix',
    titleKey: 'pages.dashboard.updateLog.entries.unitable-sparse-scroll-flash-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.unitable-sparse-scroll-flash-r01.description',
  },
{
    id: 'kuaiplm-menu-sample-build-group-r01',
    date: '2026-09-23',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.kuaiplm-menu-sample-build-group-r01.title',
    descriptionKey:
      'pages.dashboard.updateLog.entries.kuaiplm-menu-sample-build-group-r01.description',
  },
{
    id: 'login-phone-last4-disambiguation-r01',
    date: '2026-09-23',
    type: 'security',
    titleKey: 'pages.dashboard.updateLog.entries.login-phone-last4-disambiguation-r01.title',
    descriptionKey:
  ...
  },
{
    ...
    date: '2026-09-23',
    type: 'improvement',
    titleKey: 'pages.dashboard.updateLog.entries.effective-access-merge-then-auth-r01.title',
    descriptionKey:
...
/** 定制应用专属更新（scope 或 dedicatedAppCode 任一标记即可） */
export function isDedicatedPlatformUpdateEntry(entry: PlatformUpdateLogEntry): boolean {
  if (entry.scope === 'dedicated') return true;
  return String(entry.dedicatedAppCode || '').trim() !== '';
}

/** 从定制日志 catalog 收集 dedicatedAppCode（用于租户可见性匹配） */
export function collectDedicatedAppCodesFromEntries(
  entries: ReadonlyArray<PlatformUpdateLogEntry>,
): Set<string> {
  const codes = new Set<string>();
  for (const entry of entries) {
    if (!isDedicatedPlatformUpdateEntry(entry)) continue;
    const code = String(entry.dedicatedAppCode || '').trim();
    if (code) codes.add(code);
  }
  return codes;
}

/** 按日期降序合并；同一天内通用在前、定制在后 */
export function mergePlatformUpdateLogs(
  general: PlatformUpdateLogEntry[],
  dedicated: PlatformUpdateLogEntry[],
): PlatformUpdateLogEntry[] {
  const byDate = new Map<string, { general: PlatformUpdateLogEntry[]; dedicated: PlatformUpdateLogEntry[] }>();
  for (const entry of general) {
    const bucket = byDate.get(entry.date) ?? { general: [], dedicated: [] };
    bucket.general.push(entry);
    byDate.set(entry.date, bucket);
  }
  for (const entry of dedicated) {
    const bucket = byDate.get(entry.date) ?? { general: [], dedicated: [] };
    bucket.dedicated.push(entry);
    byDate.set(entry.date, bucket);
  }
  const merged: PlatformUpdateLogEntry[] = [];
  for (const date of [...byDate.keys()].sort((a, b) => b.localeCompare(a))) {
    const bucket = byDate.get(date)!;
    merged.push(...bucket.general, ...bucket.dedicated);
  }
  return merged;
}

export const PLATFORM_UPDATE_LOG: PlatformUpdateLogEntry[] = mergePlatformUpdateLogs(
  PLATFORM_UPDATE_LOG_GENERAL,
  PLATFORM_UPDATE_LOG_DEDICATED,
);

const DEDICATED_UPDATE_LOG_APP_CODES = collectDedicatedAppCodesFromEntries(
  PLATFORM_UPDATE_LOG_DEDICATED,
);

/** 已启用且出现在定制日志 catalog 中的应用 code */
export function resolveEnabledDedicatedAppCodes(
  apps: ReadonlyArray<Application>,
  dedicatedCatalogCodes: ReadonlySet<string> = DEDICATED_UPDATE_LOG_APP_CODES,
): Set<string> {
  const codes = new Set<string>();
  for (const app of apps) {
    if (!app.is_active) continue;
    const code = String(app.code || '').trim();
    if (code && dedicatedCatalogCodes.has(code)) {
      codes.add(code);
    }
  }
  return codes;
...
export function filterVisiblePlatformUpdates(
  entries: ReadonlyArray<PlatformUpdateLogEntry>,
  enabledDedicatedAppCodes: ReadonlySet<string>,
): PlatformUpdateLogEntry[] {
  return entries.filter((entry) => {
    if (!isDedicatedPlatformUpdateEntry(entry)) return true;
    const code = String(entry.dedicatedAppCode || '').trim();
    return code !== '' && enabledDedicatedAppCodes.has(code);
  });
}

export function getRecentPlatformUpdates(
  limit = 2,
  enabledDedicatedAppCodes: ReadonlySet<string> = new Set(),
): PlatformUpdateLogEntry[] {
  return filterVisiblePlatformUpdates(PLATFORM_UPDATE_LOG, enabledDedicatedAppCodes).slice(0, limit);
}

export type PlatformUpdateTabKey = 'all' | 'dedicated' | PlatformUpdateType;
...
export function filterPlatformUpdates(
  ...
  if (tab === 'dedicated') {
    return entries.filter((entry) => isDedicatedPlatformUpdateEntry(entry));
  }
...
export function getAvailableUpdateLogTabs(
  ...
  if (entries.some((entry) => isDedicatedPlatformUpdateEntry(entry))) {
    tabs.push('dedicated');
  }
  return tabs;
}
