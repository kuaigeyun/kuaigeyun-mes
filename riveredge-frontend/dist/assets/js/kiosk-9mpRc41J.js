import{F as M,r as n,j as t,G as N,ak as H,Q as w,a1 as O,a0 as R,U as _,bt as L,ax as G,aw as V,bc as W,cm as Y}from"./vendor-BP873C3N.js";import{ad as q}from"./main-DH5d15d1.js";import"./listPageStatCardsContext-izzF3TbJ.js";import{T as v}from"./clearSessionQueries-DRdpmK-8.js";import{T as Q}from"./PremiumTerminalTemplate-SwbZ8mQg.js";import"./index.es-C25BeP03.js";import"./tokenRefresh-Doe1QqeR.js";import"./index-a5v6NWST.js";import"./building-2-BWitut7d.js";import"./index-DGsOcfsG.js";import"./useRequest-Bh63mgIv.js";import"./index-DLfA8m0v.js";import"./debounce-CnMeZlNU.js";import"./throttle-DlxpcKB3.js";import"./lodash-CvrfNCWt.js";import"./createForOfIteratorHelper-BFuzW6hN.js";import"./timer-DWAvo6M8.js";import"./vendor-xlsx-CKU0L3AW.js";import"./each-CF2hQuN5.js";import"./quotation-1yCQVJ26.js";import"./sales-order-B6DdkKez.js";import"./work-order-BJQhHu9Z.js";import"./warehouse-execution-eRYaPHra.js";import"./purchase-DbAb1cBz.js";import"./purchase-requisition-C5OTHZqS.js";import"./fieldPermissionResources-Bwc2qLBC.js";import"./materialUnitDisplay-CkGktCy4.js";import"./dataDictionary-Csxwgr37.js";import"./displayContract-BCDC7G5T.js";import"./permissionResource-C4537ZA2.js";import"./documentStatus-BdTt39fW.js";import"./statusBadges-BbwOTd0P.js";import"./backendLifecycle-DVdlPVyL.js";import"./lifecycleI18n-BE5ECl-N.js";import"./globalLifecycleI18n-YKQvqC18.js";import"./listLifecycleStage-C3E9EbE4.js";const{Search:X}=_,ze=()=>{const{message:l}=M.useApp(),j=q(),[I,k]=n.useState(!1),[i,u]=n.useState(""),[g,x]=n.useState(""),[b,E]=n.useState(""),[s,C]=n.useState([]),[c,f]=n.useState(-1),y=n.useRef(null),S=n.useRef(null);n.useEffect(()=>{const e=new URLSearchParams(window.location.search),r=e.get("code"),o=e.get("programCode"),p=e.get("programUrl"),d=e.get("name")||e.get("programName");r?(u(r),x(d||"加工程序")):o?(u(o),x(d||"加工程序")):p?U(p):l.warning("请提供程序代码或程序URL")},[]);const U=async e=>{k(!0);try{const r=await fetch(e);if(!r.ok)throw new Error("加载程序失败");const o=await r.text();u(o),x("加工程序")}catch(r){l.error(r.message||"加载程序失败")}finally{k(!1)}},T=n.useCallback(e=>{if(!e||!i){C([]),f(-1);return}const r=i.split(`
