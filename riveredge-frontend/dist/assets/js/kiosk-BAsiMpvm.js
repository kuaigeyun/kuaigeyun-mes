import{C as K,r as o,j as t,D as M,a8 as O,N as w,Z as H,au as R,O as _,b7 as L,am as V,al as G,aS as W,cd as Y}from"./vendor-DF57fAD-.js";import{T as Z}from"./PremiumTerminalTemplate-BG-ju0g8.js";import{aL as q}from"./main-BOc30gs0.js";import{S as v}from"./clientRelease-CRWuV7i0.js";import"./design-B_8Sx7jg.js";import"./touch-CzJ4Jti_.js";import"./index.es-BbNG9duF.js";import"./sessionCurrentUser-DMqilkmN.js";import"./globalStore-C9qZP-_V.js";import"./restoredUser-Dlw53-al.js";import"./tokenRefresh-BvNkSTdF.js";import"./building-2-C3DgydGd.js";import"./clearSessionQueries-Db_KN_8V.js";import"./index-DpsXMatM.js";const{Search:X}=_,pe=()=>{const{message:a}=K.useApp(),j=q(),[I,C]=o.useState(!1),[i,m]=o.useState(""),[f,x]=o.useState(""),[b,E]=o.useState(""),[n,k]=o.useState([]),[c,u]=o.useState(-1),y=o.useRef(null),S=o.useRef(null);o.useEffect(()=>{const e=new URLSearchParams(window.location.search),s=e.get("code"),r=e.get("programCode"),d=e.get("programUrl"),h=e.get("name")||e.get("programName");s?(m(s),x(h||"加工程序")):r?(m(r),x(h||"加工程序")):d?U(d):a.warning("请提供程序代码或程序URL")},[]);const U=async e=>{C(!0);try{const s=await fetch(e);if(!s.ok)throw new Error("加载程序失败");const r=await s.text();m(r),x("加工程序")}catch(s){a.error(s.message||"加载程序失败")}finally{C(!1)}},T=o.useCallback(e=>{if(!e||!i){k([]),u(-1);return}const s=i.split(`
