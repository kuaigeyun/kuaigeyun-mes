import{F as K,r as o,j as t,G as M,ai as N,Q as w,a0 as _,ad as R,U as O,bh as v,av as G,au as V,a_ as W,ch as Y}from"./vendor-BpC5dbqE.js";import{T as q}from"./PremiumTerminalTemplate-CpCQIFel.js";import{ac as Q}from"./main-DWiISOHf.js";import{H as L}from"./clearSessionQueries-CFqkMa_J.js";import"./design-B_8Sx7jg.js";import"./touch-CzJ4Jti_.js";import"./index.es-SKZRCHJ3.js";import"./sessionCurrentUser-6oLP0QSj.js";import"./tokenRefresh-BxzH3n5T.js";import"./building-2-Co5vsZIQ.js";import"./index-D3TI4B4O.js";const{Search:X}=O,ie=()=>{const{message:l}=K.useApp(),j=Q(),[I,k]=o.useState(!1),[i,m]=o.useState(""),[f,x]=o.useState(""),[b,E]=o.useState(""),[n,C]=o.useState([]),[c,u]=o.useState(-1),y=o.useRef(null),S=o.useRef(null);o.useEffect(()=>{const e=new URLSearchParams(window.location.search),s=e.get("code"),r=e.get("programCode"),d=e.get("programUrl"),h=e.get("name")||e.get("programName");s?(m(s),x(h||"加工程序")):r?(m(r),x(h||"加工程序")):d?U(d):l.warning("请提供程序代码或程序URL")},[]);const U=async e=>{k(!0);try{const s=await fetch(e);if(!s.ok)throw new Error("加载程序失败");const r=await s.text();m(r),x("加工程序")}catch(s){l.error(s.message||"加载程序失败")}finally{k(!1)}},T=o.useCallback(e=>{if(!e||!i){C([]),u(-1);return}const s=i.split(`
