...
- ✅ `idx_platform_tenants_domain` - 平台级表索引（platform_ 前缀，符合主流 B 端命名）
- ✅ `idx_core_users_tenant_id` - 系统级表索引（core_ 前缀，符合主流 B 端命名）
