"""
执行 calculation_status 字段迁移

直接执行 55_20260120000011_add_calculation_status_to_cost_calculations.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "55_20260120000011_add_calculation_status_to_cost_calculations.py"
    ...
    try:
        ...
        if field_exists:
            print("✅ 字段 calculation_status 已成功添加到表中")
        else:
