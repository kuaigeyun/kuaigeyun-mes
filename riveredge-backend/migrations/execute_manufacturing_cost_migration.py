"""
执行 manufacturing_cost 字段迁移

直接执行 54_20260120000010_add_manufacturing_cost_to_cost_calculations.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "54_20260120000010_add_manufacturing_cost_to_cost_calculations.py"
    ...
    try:
        ...
        if field_exists:
            print("✅ 字段 manufacturing_cost 已成功添加到表中")
        else:
