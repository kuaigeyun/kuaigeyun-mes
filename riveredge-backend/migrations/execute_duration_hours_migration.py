"""
执行 duration_hours 字段迁移

直接执行 47_20260120000003_add_duration_hours_to_document_node_timings.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "47_20260120000003_add_duration_hours_to_document_node_timings.py"
    ...
    try:
        ...
        if field_exists:
            print("✅ 字段 duration_hours 已成功添加到表中")
        else:
