...
直接执行 48_20260120000004_add_node_code_to_document_node_timings.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "48_20260120000004_add_node_code_to_document_node_timings.py"
