"""
执行 rule_parameters 字段迁移

直接执行 49_20260120000005_add_rule_parameters_to_cost_rules.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "49_20260120000005_add_rule_parameters_to_cost_rules.py"
    ...
    try:
        ...
        if field_exists:
            print("✅ 字段 rule_parameters 已成功添加到表中")
        else:
