...
-- apps_kuaizhizao_inventory_alerts：迁移 14 旧表无 triggered_at 等列，161 中 IF NOT EXISTS 会跳过建表但索引仍会引用新列；建表/索引/注释见 180_20260411130000_fix_inventory_alerts_legacy_and_comments.py
