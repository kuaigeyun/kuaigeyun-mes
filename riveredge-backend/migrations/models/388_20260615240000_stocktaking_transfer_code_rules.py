"""
补建盘点单、调拨单编码规则（STOCKTAKING_CODE / INVENTORY_TRANSFER_CODE）。
...
_RULES = (
    {
        "code": "STOCKTAKING_CODE",
        "name": "盘点单编码规则",
        "prefix": "ST",
        "description": "盘点单编码规则，格式：ST + 日期（YYYYMMDD）+ 4位序号，每日重置",
    },
    {
        "code": "INVENTORY_TRANSFER_CODE",
        "name": "调拨单编码规则",
        "prefix": "TR",
        "description": "调拨单编码规则，格式：TR + 日期（YYYYMMDD）+ 4位序号，每日重置",
    },
)
