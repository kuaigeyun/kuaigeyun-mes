"""
执行 calculation_no 字段迁移

直接执行 53_20260120000009_add_calculation_no_to_cost_calculations.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "53_20260120000009_add_calculation_no_to_cost_calculations.py"
    ...
    try:
        ...
        if field_exists:
            print("✅ 字段 calculation_no 已成功添加到表中")
        else:
