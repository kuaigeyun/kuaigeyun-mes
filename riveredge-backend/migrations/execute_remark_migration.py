...
直接执行 52_20260120000008_add_remark_to_cost_calculations.py 中的 SQL 语句。
...
async def execute_migration():
    """执行迁移"""
    # 读取迁移文件
    migration_file = Path(__file__).parent / "models" / "52_20260120000008_add_remark_to_cost_calculations.py"
