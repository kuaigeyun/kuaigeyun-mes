...
async def apply_migration():
    ...
    migration_file = project_root / "migrations" / "models" / "65_20260127000000_operation_defect_types_and_default_operator.py"
