...
REGISTRY_PARAM_CONTROL_META: Dict[str, Dict[str, Any]] = {
    ...
    "parameters.reporting.kingdee_production_report_push": {"type": "object"},
    "parameters.work_order.kingdee_production_order_push": {"type": "object"},
    "parameters.work_order.document_push_targets": {"type": "object"},
    "parameters.sales.kingdee_sales_order_push": {"type": "object"},
    "parameters.sales.document_push_targets": {"type": "object"},
    "parameters.purchase.kingdee_purchase_order_push": {"type": "object"},
    "parameters.purchase.document_push_targets": {"type": "object"},
    "parameters.warehouse.kingdee_inventory_push": {"type": "object"},
    "parameters.warehouse.document_push_targets": {"type": "object"},
...
DEFAULT_PARAMETERS: Dict[str, Dict[str, Any]] = {
    ...
    "work_order": {
        ...
        "kingdee_production_order_push": {
            "enabled": False,
            "form_id": "PRD_MO",
            "bill_type_number": "SCDD01_SYS",
            "need_return_fields": ["FID", "FBillNo"],
            "use_local_bill_no": True,
            "submit_after_save": False,
            "audit_after_save": False,
            "fail_on_error": False,
        },
        "document_push_targets": ["kingdee_prd_mo"],
        "score_profiles": {
            "scheduling": {
                "weights": {
    ...
    "warehouse": {
        ...
        "document_push_targets": ["kingdee_stk_miscellaneous"],
    },
    "quality": {
    ...
    "sales": {
        ...
        "document_push_targets": ["kingdee_sal_saleorder"],
        "sales_review": {
            "dept_bindings": {},
        },
    },
    "purchase": {
        ...
        "document_push_targets": ["kingdee_pur_purchaseorder"],
    },
    "procurement": {
