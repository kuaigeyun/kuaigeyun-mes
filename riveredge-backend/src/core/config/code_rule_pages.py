...
CODE_RULE_PAGES: List[CodeRulePageConfig] = [
    ...
    },
    {
        ...
        "page_name": "模具厂内维修单",
        "page_path": "/apps/haoligo/molds/documents/maintenance",
        "code_field": "sheet_no",
    ...
    },
    {
        ...
        "page_name": "模具维保完成单",
        "page_path": "/apps/haoligo/molds/documents/maintenance-complete",
        "code_field": "sheet_no",
    ...
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "模具外协维保单默认规则：固定字符「WXWB」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "模具外协维保完成单默认规则：固定字符「WXWBWX」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
