...
CODE_RULE_PAGES: List[CodeRulePageConfig] = [
    ...
    # 好力 GO — 模具单据单号默认规则（与流水号配置 UI 一致）：固定字符 + 提交日期（YYMMDD）+ 3 位自动计数（每日重置）
    {
        ...
        "code_rule_description": "试模单默认规则：固定字符「SM」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "领用单默认规则：固定字符「LY」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "还入单默认规则：固定字符「HR」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
    ...
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "维保完修单默认规则：固定字符「WBWX」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "外协维保单默认规则：固定字符「WXWB」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "外协维保完修单默认规则：固定字符「WXWBWX」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
    ...
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "设备保养单默认规则：固定字符「BY」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
        ...
        "code_date_preset_format": "YYMMDD",
        "code_counter_digits": 3,
        "code_rule_description": "设备保养完成单默认规则：固定字符「BYWC」+ 提交日期（YYMMDD）+ 自动计数（3 位数字，每日重置）",
    },
    {
