...
from core.models.mold import Mold, MoldUsage
from core.schemas.mold import (
    MoldCreate,
    MoldUpdate,
    MoldResponse,
    MoldListResponse,
...
from core.services.mold_service import MoldService, MoldUsageService
from core.api.deps.deps import get_current_tenant
from infra.api.deps.deps import get_current_user as soil_get_current_user
from infra.models.user import User
from infra.exceptions.exceptions import NotFoundError, ValidationError

router = APIRouter(prefix="/molds", tags=["Core Molds"])
