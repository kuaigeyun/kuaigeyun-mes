...
PRESET_APP_CONNECTORS: List[Dict[str, Any]] = [
    ...
    # ERP（精确到具体产品）
    {"id": "kingdee_galaxy", "name": "金蝶云星空", "type": "kingdee_galaxy", "category": "erp", "description": "金蝶云星空 WebAPI", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_id": "", "app_secret": "", "acct_id": "", "lcid": "2052"}},
    ...
    {"id": "tencent_cos", "name": "腾讯云 COS", "type": "tencent_cos", "category": "storage", "description": "腾讯云对象存储 COS", "icon": "CloudServerOutlined", "default_config": {"endpoint": "", "secret_id": "", "secret_key": "", "bucket": "", "region": "ap-guangzhou"}},
    ...
    {"id": "minio", "name": "MinIO", "type": "minio", "category": "storage", "description": "MinIO S3 兼容对象存储", "icon": "HddOutlined", "default_config": {"endpoint": "", "access_key": "", "secret_key": "", "bucket": "", "region": "us-east-1", "use_path_style": True}},
