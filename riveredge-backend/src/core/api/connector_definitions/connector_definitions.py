...
PRESET_APP_CONNECTORS: List[Dict[str, Any]] = [
    ...
    # ERP（精确到具体产品）
    {"id": "kingdee_galaxy", "name": "金蝶云星空", "type": "kingdee_galaxy", "category": "erp", "description": "金蝶云星空 WebAPI", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_id": "", "app_secret": "", "acct_id": "", "username": "", "lcid": "2052"}},
    {"id": "kingdee_xingchen", "name": "金蝶云星辰", "type": "kingdee_xingchen", "category": "erp", "description": "金蝶云星辰开放接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_id": "", "app_secret": "", "acct_id": "", "lcid": "2052"}},
    {"id": "kingdee_kis_cloud", "name": "金蝶 KIS 云", "type": "kingdee_kis_cloud", "category": "erp", "description": "金蝶 KIS 云开放接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_id": "", "app_secret": "", "acct_id": "", "lcid": "2052"}},
    {"id": "kingdee_kis", "name": "金蝶 KIS", "type": "kingdee_kis", "category": "erp", "description": "金蝶 KIS 专业版 / 商贸版接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "instance_id": "", "app_secret": ""}},
    {"id": "yonyou_yonbip", "name": "用友 YonBIP", "type": "yonyou_yonbip", "category": "erp", "description": "用友 YonBIP 开放平台", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": "", "corp_id": "", "user_id": ""}},
    {"id": "yonyou_u8", "name": "用友 U8", "type": "yonyou_u8", "category": "erp", "description": "用友 U8 OpenAPI", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": "", "corp_id": "", "user_id": ""}},
    {"id": "yonyou_u9", "name": "用友 U9", "type": "yonyou_u9", "category": "erp", "description": "用友 U9 开放接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": "", "corp_id": "", "user_id": ""}},
    {"id": "yonyou_nc", "name": "用友 NC Cloud", "type": "yonyou_nc", "category": "erp", "description": "用友 NC Cloud 开放平台", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": "", "corp_id": "", "user_id": ""}},
    {"id": "sap_s4hana", "name": "SAP S/4HANA", "type": "sap_s4hana", "category": "erp", "description": "SAP S/4HANA Cloud OData / API", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "client": "", "username": "", "password": "", "language": "ZH"}},
    {"id": "sap_b1", "name": "SAP Business One", "type": "sap_b1", "category": "erp", "description": "SAP Business One Service Layer", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "company_db": "", "username": "", "password": "", "language": "ZH"}},
    {"id": "oracle_netsuite", "name": "Oracle NetSuite", "type": "oracle_netsuite", "category": "erp", "description": "Oracle NetSuite SuiteTalk / REST", "icon": "CloudOutlined", "default_config": {"base_url": "", "account": "", "consumer_key": "", "consumer_secret": "", "token_id": "", "token_secret": ""}},
    {"id": "odoo", "name": "Odoo", "type": "odoo", "category": "erp", "description": "Odoo External API / XML-RPC", "icon": "CloudOutlined", "default_config": {"base_url": "", "db": "", "username": "", "password": ""}},
    {"id": "inspur_gs", "name": "浪潮 GS Cloud", "type": "inspur_gs", "category": "erp", "description": "浪潮 GS Cloud 开放接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": ""}},
    {"id": "inspur_ps", "name": "浪潮 PS Cloud", "type": "inspur_ps", "category": "erp", "description": "浪潮 PS Cloud 开放接口", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": ""}},
    {"id": "digiwin_t100", "name": "鼎捷 T100", "type": "digiwin_t100", "category": "erp", "description": "鼎捷 T100 REST API", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "username": "", "password": "", "company_id": ""}},
    {"id": "digiwin_yifei", "name": "鼎捷易飞", "type": "digiwin_yifei", "category": "erp", "description": "鼎捷易飞 REST API", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "username": "", "password": "", "company_id": ""}},
    {"id": "digiwin_yizhu", "name": "鼎捷易助", "type": "digiwin_yizhu", "category": "erp", "description": "鼎捷易助 REST API", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "username": "", "password": "", "company_id": ""}},
    {"id": "digiwin_yituo", "name": "鼎捷易拓", "type": "digiwin_yituo", "category": "erp", "description": "鼎捷易拓 REST API", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "username": "", "password": "", "company_id": ""}},
    ...
    {"id": "chanjet_tplus", "name": "畅捷通 T+", "type": "chanjet_tplus", "category": "erp", "description": "畅捷通 T+ OpenAPI", "icon": "CloudOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": ""}},
    {"id": "grasp_huihuang", "name": "管家婆辉煌", "type": "grasp_huihuang", "category": "erp", "description": "管家婆辉煌系列开放接口", "icon": "DatabaseOutlined", "default_config": {"base_url": "", "app_key": "", "app_secret": ""}},
    ...
    {"id": "erpnext", "name": "ERPNext", "type": "erpnext", "category": "erp", "description": "ERPNext REST API", "icon": "CloudOutlined", "default_config": {"base_url": "", "api_key": "", "api_secret": ""}},
