...
class PlatformSuperAdmin(BaseModel):
    """
    平台超级管理员模型
    ...
    class Meta:
        ...
        模型元数据
        """
        table = "soil_platform_superadmin"  # 表名必须包含模块前缀（soil_ - 平台级后端）
        indexes = [
    ...
    def __str__(self) -> str:
        ...
        Returns:
            str: 平台超级管理员字符串表示
        """
        return f"<PlatformSuperAdmin(id={self.id}, username={self.username})>"
    ...
    def hash_password(password: str) -> str:
        ...
        Example:
            >>> hashed = PlatformSuperAdmin.hash_password("mypassword")
            >>> len(hashed) > 0
            True
        """
    ...
    def verify_password(self, password: str) -> bool:
        ...
        Example:
            ...
            >>> admin.password_hash = PlatformSuperAdmin.hash_password("mypassword")
