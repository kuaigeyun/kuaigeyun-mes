...
class HolidayBase(BaseModel):
    ...
    holiday_date: date = Field(..., description="假期日期")
    holiday_type: Optional[str] = Field(None, max_length=50, description="假期类型")
...
class HolidayUpdate(BaseModel):
    ...
    holiday_date: Optional[date] = Field(None, description="假期日期")
    holiday_type: Optional[str] = Field(None, max_length=50, description="假期类型")
    description: Optional[str] = Field(None, description="描述")
