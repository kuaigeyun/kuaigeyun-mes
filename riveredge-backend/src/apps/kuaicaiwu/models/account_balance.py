...
class AccountBalance(BaseModel):
    ...
    opening_debit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="期初借方")
    opening_credit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="期初贷方")
    period_debit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="本期借方")
    period_credit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="本期贷方")
    year_debit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="本年累计借方")
    year_credit = fields.DecimalField(max_digits=18, decimal_places=2, default=0, description="本年累计贷方")
