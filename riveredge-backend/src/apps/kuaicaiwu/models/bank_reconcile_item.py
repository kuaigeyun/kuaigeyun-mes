...
class BankReconcileItem(BaseModel):
    ...
    debit_amount = fields.DecimalField(max_digits=14, decimal_places=2, default=0, description="借方")
    credit_amount = fields.DecimalField(max_digits=14, decimal_places=2, default=0, description="贷方")
