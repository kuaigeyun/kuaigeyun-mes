...
class Receivable(BaseModel):
    ...
    receivable_code = fields.CharField(max_length=50, db_index=True, description="应收单编码")  # 租户内未删除唯一，见迁移 463
    ...
    class Meta:
        table = "apps_kuaicaiwu_receivables"
        table_description = "轻管理会计 - 应收单"
        indexes = [
