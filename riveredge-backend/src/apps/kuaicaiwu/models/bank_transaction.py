...
class BankTransaction(BaseModel):
    ...
    amount = fields.DecimalField(max_digits=14, decimal_places=2, description="交易金额")
    balance_after = fields.DecimalField(max_digits=14, decimal_places=2, description="交易后余额")
