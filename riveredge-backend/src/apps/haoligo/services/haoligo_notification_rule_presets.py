...
HAOLIGO_NOTIFICATION_RULE_PRESETS: List[Dict[str, Any]] = [
    ...
    {
        "id": "haoligo_preset_equipment_acceptance_trial_pending",
        "scene_name": "设备验收单·待试产",
        "trigger_document": DOC_EQUIPMENT_ACCEPTANCE,
        "trigger_action": ACTION_TRIAL_PENDING,
        "template_code": HAOLIGO_EQUIPMENT_ACCEPTANCE_TRIAL_PENDING,
        "recipient_scopes": ["module_acceptance_execute_operators", "user_specified"],
    },
    {
        "id": "haoligo_preset_equipment_acceptance_trial_failed",
        "scene_name": "设备验收单·试产不合格退回",
        "trigger_document": DOC_EQUIPMENT_ACCEPTANCE,
        "trigger_action": ACTION_TRIAL_FAILED,
        "template_code": HAOLIGO_EQUIPMENT_ACCEPTANCE_TRIAL_FAILED,
        "recipient_scopes": ["commissioning_operators", "creator", "user_specified"],
    },
    {
        "id": "haoligo_preset_equipment_acceptance_accepted",
        "scene_name": "设备验收单·验收合格",
        "trigger_document": DOC_EQUIPMENT_ACCEPTANCE,
        "trigger_action": ACTION_ACCEPTED,
        "template_code": HAOLIGO_EQUIPMENT_ACCEPTANCE_ACCEPTED,
        "recipient_scopes": ["creator", "commissioning_operators", "user_specified"],
    },
    {
    ...
    {
        "id": "haoligo_preset_quality_issue_submitted",
        "scene_name": "品质问题·登记待处理",
        "trigger_document": DOC_QUALITY_ISSUE_TRACKING,
        "trigger_action": ACTION_SUBMITTED,
        "template_code": HAOLIGO_QUALITY_ISSUE_SUBMITTED,
        "recipient_scopes": ["reporter", "user_specified"],
    },
    {
        "id": "haoligo_preset_quality_issue_completed",
        "scene_name": "品质问题·处理完成回传",
        "trigger_document": DOC_QUALITY_ISSUE_TRACKING,
        "trigger_action": ACTION_COMPLETED,
        "template_code": HAOLIGO_QUALITY_ISSUE_COMPLETED,
        "recipient_scopes": ["reporter"],
    },
    {
        "id": "haoligo_preset_quality_issue_temporary_overdue",
        "scene_name": "品质问题·临时措施逾期",
        "trigger_document": DOC_QUALITY_ISSUE_TRACKING,
        "trigger_action": ACTION_TEMPORARY_OVERDUE,
        "template_code": HAOLIGO_QUALITY_ISSUE_TEMPORARY_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
    {
        "id": "haoligo_preset_quality_issue_long_term_overdue",
        "scene_name": "品质问题·长期措施逾期",
        "trigger_document": DOC_QUALITY_ISSUE_TRACKING,
        "trigger_action": ACTION_LONG_TERM_OVERDUE,
        "template_code": HAOLIGO_QUALITY_ISSUE_LONG_TERM_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
    {
        "id": "haoligo_preset_customer_complaint_submitted",
        "scene_name": "客户投诉·登记待处理",
        "trigger_document": DOC_CUSTOMER_COMPLAINT,
        "trigger_action": ACTION_SUBMITTED,
        "template_code": HAOLIGO_CUSTOMER_COMPLAINT_SUBMITTED,
        "recipient_scopes": ["reporter", "user_specified"],
    },
    {
        "id": "haoligo_preset_customer_complaint_completed",
        "scene_name": "客户投诉·处理完成回传",
        "trigger_document": DOC_CUSTOMER_COMPLAINT,
        "trigger_action": ACTION_COMPLETED,
        "template_code": HAOLIGO_CUSTOMER_COMPLAINT_COMPLETED,
        "recipient_scopes": ["reporter"],
    },
    {
        "id": "haoligo_preset_customer_complaint_temporary_overdue",
        "scene_name": "客户投诉·临时措施逾期",
        "trigger_document": DOC_CUSTOMER_COMPLAINT,
        "trigger_action": ACTION_TEMPORARY_OVERDUE,
        "template_code": HAOLIGO_CUSTOMER_COMPLAINT_TEMPORARY_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
    {
        "id": "haoligo_preset_customer_complaint_long_term_overdue",
        "scene_name": "客户投诉·长期措施逾期",
        "trigger_document": DOC_CUSTOMER_COMPLAINT,
        "trigger_action": ACTION_LONG_TERM_OVERDUE,
        "template_code": HAOLIGO_CUSTOMER_COMPLAINT_LONG_TERM_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
    {
        "id": "haoligo_preset_line_stop_submitted",
        "scene_name": "停线反馈·登记待处理",
        "trigger_document": DOC_LINE_STOP_FEEDBACK,
        "trigger_action": ACTION_SUBMITTED,
        "template_code": HAOLIGO_LINE_STOP_SUBMITTED,
        "recipient_scopes": ["reporter", "user_specified"],
    },
    {
        "id": "haoligo_preset_line_stop_completed",
        "scene_name": "停线反馈·处理完成回传",
        "trigger_document": DOC_LINE_STOP_FEEDBACK,
        "trigger_action": ACTION_COMPLETED,
        "template_code": HAOLIGO_LINE_STOP_COMPLETED,
        "recipient_scopes": ["reporter"],
    },
    {
        "id": "haoligo_preset_line_stop_temporary_overdue",
        "scene_name": "停线反馈·临时措施逾期",
        "trigger_document": DOC_LINE_STOP_FEEDBACK,
        "trigger_action": ACTION_TEMPORARY_OVERDUE,
        "template_code": HAOLIGO_LINE_STOP_TEMPORARY_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
    {
        "id": "haoligo_preset_line_stop_long_term_overdue",
        "scene_name": "停线反馈·长期措施逾期",
        "trigger_document": DOC_LINE_STOP_FEEDBACK,
        "trigger_action": ACTION_LONG_TERM_OVERDUE,
        "template_code": HAOLIGO_LINE_STOP_LONG_TERM_OVERDUE,
        "recipient_scopes": ["user_specified"],
    },
]
