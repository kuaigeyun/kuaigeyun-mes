...
@router.get(
    ...
    summary="保养项列表",
    dependencies=[Depends(require_haoligo_module_access("equipment-upkeep-params"))],
)
...
@router.get(
    ...
    summary="保养方案列表",
    dependencies=[Depends(require_haoligo_module_access("equipment-upkeep-param-sets"))],
)
