...
class HaoligoMoldUpkeepParamSet(HaoligoTenantModel):
    """模具保养方案（参数集）。"""

    class Meta:
        table = "haoligo_mold_upkeep_param_set"
        table_description = "好力GO - 模具保养方案"
...
class HaoligoMoldUpkeepParam(HaoligoTenantModel):
    """模具保养项。"""

    class Meta:
        table = "haoligo_mold_upkeep_param"
        table_description = "好力GO - 模具保养项"
        unique_together = [("tenant_id", "code")]
        indexes = [("tenant_id",), ("code",)]
...
class HaoligoMoldUpkeepParamSetItem(HaoligoTenantModel):
    """保养方案明细。"""

    class Meta:
        table = "haoligo_mold_upkeep_param_set_item"
        table_description = "好力GO - 模具保养方案明细"
