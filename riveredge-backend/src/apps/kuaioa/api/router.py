...
from apps.kuaioa.api.approval_processs import router as approval_processs_router
...
from apps.kuaioa.api.meeting_minutess import router as meeting_minutess_router
...
# 注册子路由
router.include_router(approval_processs_router)
...
router.include_router(meeting_minutess_router)
