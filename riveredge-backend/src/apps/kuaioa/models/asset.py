...
class KuaioaAssetPurchase(BaseModel):
    ...
    estimated_amount = fields.DecimalField(max_digits=18, decimal_places=2, null=True, description="预估金额")
...
class KuaioaAsset(BaseModel):
    ...
    purchase_amount = fields.DecimalField(max_digits=18, decimal_places=2, null=True, description="采购金额")
