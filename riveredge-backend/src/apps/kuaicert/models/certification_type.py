...
class CertificationType(BaseModel):
    ...
    class Meta:
        ...
        模型元数据
        """
        table = "seed_kuaicert_certification_types"
        indexes = [
            ("tenant_id",),
            ("type_code",),
            ("uuid",),
...
class CertificationStandard(BaseModel):
    ...
    class Meta:
        ...
        模型元数据
        """
        table = "seed_kuaicert_certification_standards"
        indexes = [
            ("tenant_id",),
            ("standard_no",),
            ("uuid",),
...
class ScoringRule(BaseModel):
    ...
    class Meta:
        ...
        模型元数据
        """
        table = "seed_kuaicert_scoring_rules"
        indexes = [
            ("tenant_id",),
            ("rule_no",),
            ("uuid",),
    ...
    def __str__(self):
        return f"{self.rule_no} - {self.rule_name}"
