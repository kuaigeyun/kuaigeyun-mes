...
def derive_sales_return_capabilities(
    ...
    *,
    ...
    if _is_cancelled(status):
        ...
        confirm_reason = "sales_return.confirm.not_audited"
    else:
    ...
    withdraw_submit_cap = _cap(
        ...
        "sales_return.withdraw_submit.not_pending"
    ...
    approve_cap = _cap(
        ...
        "sales_return.approve.not_pending" if not _is_review_pending(review_status) else None,
    )
    ...
    revoke_cap = _cap(
        revoke_allowed,
        "sales_return.revoke_approval.not_allowed" if not revoke_allowed else None,
    )
