...
class Stocktaking(BaseModel):
    ...
    total_difference_amount = fields.DecimalField(max_digits=18, decimal_places=4, default=0, description="差异总金额")
...
class StocktakingItem(BaseModel):
    ...
    # 数量信息（与库存账面 DECIMAL(18,4) / decimal_limits 对齐）
    book_quantity = fields.DecimalField(max_digits=18, decimal_places=4, description="账面数量")
    actual_quantity = fields.DecimalField(max_digits=18, decimal_places=4, null=True, description="实际数量")
    difference_quantity = fields.DecimalField(max_digits=18, decimal_places=4, default=0, description="差异数量")

    # 金额信息
    unit_price = fields.DecimalField(max_digits=18, decimal_places=4, default=0, description="单价")
    difference_amount = fields.DecimalField(max_digits=18, decimal_places=4, default=0, description="差异金额")
