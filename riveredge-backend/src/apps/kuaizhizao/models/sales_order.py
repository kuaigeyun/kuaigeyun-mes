...
class SalesOrder(BaseModel):
    ...
    total_fee_amount = fields.DecimalField(max_digits=16, decimal_places=4, default=0, description="总费用金额")
    ...
    prepayment_amount = fields.DecimalField(
        max_digits=16, decimal_places=4, null=True, description="预收款金额"
    )
