...
from tree_root.schemas.data_dictionary import (
    DataDictionaryCreate,
    DataDictionaryUpdate,
    DataDictionaryResponse,
)
from tree_root.schemas.dictionary_item import (
...
router = APIRouter(prefix="/data-dictionaries", tags=["System Data Dictionaries"])
